function main()
{
    ...
    for ( var i = 0; i < nfaces; i++ )
    {
        geometry.faces[i].vertexColors[0] = lut.getColor(scalars[0]);
        geometry.faces[i].vertexColors[1] = lut.getColor(scalars[1]);
        geometry.faces[i].vertexColors[2] = lut.getColor(scalars[2]);
    }
